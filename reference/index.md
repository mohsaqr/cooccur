...
- [`actor_genres`](https://saqr.me/cooccure/reference/actor_genres.md) :
...
- [`demo`](https://saqr.me/cooccure/reference/demo.md) : Demo
  actor-movie-genre table
- [`launch_app()`](https://saqr.me/cooccure/reference/launch_app.md) :
  Launch the cooccure Shiny explorer
- [`movies`](https://saqr.me/cooccure/reference/movies.md) : IMDB movie
  metadata (1970-2024)
- [`plot(`*`<cooccurrence>`*`)`](https://saqr.me/cooccure/reference/plot.cooccurrence.md)
